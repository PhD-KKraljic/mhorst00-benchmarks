...
#ifdef LIKWID_ROCMON
	printf("setting LIKWID ROCm marker\n");
	ROCMON_MARKER_INIT;
	ROCMON_MARKER_REGISTER("roc_cachebench");
	ROCMON_MARKER_START("roc_cachebench");
#endif
...
#ifdef LIKWID_ROCMON
	printf("closing LIKWID ROCm marker\n");
	ROCMON_MARKER_STOP("roc_cachebench");
	ROCMON_MARKER_CLOSE;
#endif
