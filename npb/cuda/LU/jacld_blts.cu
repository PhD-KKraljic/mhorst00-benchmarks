                     ...
                     int blk_size_k, int blk_size)
{
  switch (g_opt_level) {
    case OPT_BASELINE:
      jacld_blts_init_baseline(iter, item_default, 
                               blk_size_k, blk_size);
      break;
    case OPT_GLOBALMEM:
      jacld_blts_init_gmem(iter, item_default, 
                           blk_size_k, blk_size);
      break;
    case OPT_SYNC:
      jacld_blts_init_sync(iter, item_default, 
                           blk_size_k, blk_size);
      break;
    case OPT_FULL:
      jacld_blts_init_fullopt(iter, item_default, 
                              blk_size_k, blk_size);
      break;
    case OPT_PARALLEL:
    case OPT_MEMLAYOUT:
