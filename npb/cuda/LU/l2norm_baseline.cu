                          ...
                          int ist, int iend)
{
  ...
  cuda_ProfilerStartEventRecord("k_l2norm_baseline",  cmd_q[KERNEL_Q]);
  k_l2norm_baseline<<< gws / lws, lws, 0, cmd_q[KERNEL_Q]>>>
    (
     m_rsd[buf_idx], m_sum, 
     m_tmp_sum, 
     nz0, jst, jend,
  ...
  cuda_ProfilerEndEventRecord("k_l2norm_baseline",  cmd_q[KERNEL_Q]);
