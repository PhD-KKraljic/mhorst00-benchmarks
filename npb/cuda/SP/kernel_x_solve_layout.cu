...
//---------------------------------------------------------------------
// dummy functions. will be removed.
//---------------------------------------------------------------------
__global__ void x_solve5_layout() { }
__global__ void x_solve6_layout() { }
__global__ void x_solve7_layout() { }
__global__ void x_solve8_layout() { }
__global__ void x_solve9_layout() { }

//---------------------------------------------------------------------
// block-diagonal matrix-vector multiplication                       
//---------------------------------------------------------------------
__global__ void k_ninvr_layout(
   double *g_rhs0,
   double *g_rhs1,
   double *g_rhs2,
   double *g_rhs3,
