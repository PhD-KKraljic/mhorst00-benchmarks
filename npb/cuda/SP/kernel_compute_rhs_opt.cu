...
//---------------------------------------------------------------------
__global__ void k_compute_rhs0_opt(
   double *g_u0,
   double *g_u1,
   double *g_u2,
   double *g_u3,
...
{
   double (*u0)[JMAXP+1][IMAXP+1] = 
    ( double (*)[JMAXP+1][IMAXP+1])g_u0;
   double (*u1)[JMAXP+1][IMAXP+1] = 
    ( double (*)[JMAXP+1][IMAXP+1])g_u1;
   double (*u2)[JMAXP+1][IMAXP+1] = 
    ( double (*)[JMAXP+1][IMAXP+1])g_u2;
   double (*u3)[JMAXP+1][IMAXP+1] = 
    ( double (*)[JMAXP+1][IMAXP+1])g_u3;
   double (*u4)[JMAXP+1][IMAXP+1] = 
    ( double (*)[JMAXP+1][IMAXP+1])g_u4;
   ...
   double (*square)[JMAXP+1][IMAXP+1] = 
    ( double (*)[JMAXP+1][IMAXP+1])g_square;
  ...
  if (base_k + k > nz2+1 || j > ny2+1 || i > nx2+1) return;
...
__global__ void k_compute_rhs1_opt(
  ...
  const int nx2, const int ny2, const int nz2)
{
   double (*forcing0)[JMAXP+1][IMAXP+1] = 
    ( double (*)[JMAXP+1][IMAXP+1])g_forcing0;
   double (*forcing1)[JMAXP+1][IMAXP+1] = 
    ( double (*)[JMAXP+1][IMAXP+1])g_forcing1;
   double (*forcing2)[JMAXP+1][IMAXP+1] = 
    ( double (*)[JMAXP+1][IMAXP+1])g_forcing2;
   double (*forcing3)[JMAXP+1][IMAXP+1] = 
    ( double (*)[JMAXP+1][IMAXP+1])g_forcing3;
   double (*forcing4)[JMAXP+1][IMAXP+1] = 
    ( double (*)[JMAXP+1][IMAXP+1])g_forcing4;
