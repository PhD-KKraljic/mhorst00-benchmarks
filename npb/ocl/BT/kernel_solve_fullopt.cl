...
//---------------------------------------------------------------------
__kernel void x_solve1_fullopt(__global double *m_lhsA, 
                               ...
                               int split_flag)
{
  ...
  __global double (* lhsA)[5][WORK_NUM_ITEM_DEFAULT][PROBLEM_SIZE+1][PROBLEM_SIZE-1]
    = (__global double (*) [5][WORK_NUM_ITEM_DEFAULT][PROBLEM_SIZE+1][PROBLEM_SIZE-1])m_lhsA;
  __global double (* lhsB)[5][WORK_NUM_ITEM_DEFAULT][PROBLEM_SIZE+1][PROBLEM_SIZE-1]
    = (__global double (*) [5][WORK_NUM_ITEM_DEFAULT][PROBLEM_SIZE+1][PROBLEM_SIZE-1])m_lhsB;
  __global double (* lhsC)[5][WORK_NUM_ITEM_DEFAULT][PROBLEM_SIZE+1][PROBLEM_SIZE-1]
    = (__global double (*) [5][WORK_NUM_ITEM_DEFAULT][PROBLEM_SIZE+1][PROBLEM_SIZE-1])m_lhsC;
...
// This function computes the left hand side in the xi-direction
//---------------------------------------------------------------------
inline void compute_fjac_x(__private double fjac[5][5], 
...
inline void compute_njac_x(__private double  njac[5][5], 
                           __private double t_u[5], 
                           double rho_i,
                           double c3c4, 
                           double con43, 
...
void x_solve2_fullopt(__global double *m_qs, 
...
// This function computes the left hand side in the xi-direction
//---------------------------------------------------------------------
__kernel void x_solve3_fullopt(__global double *m_rhs,
                               __global double *m_lhsA, 
                               __global double *m_lhsB, 
                               __global double *m_lhsC,
                               int gp0, int gp1, int gp2,
                               __local double *tmp_l_lhs, 
                               __local double *tmp_l_r,
                               int work_base, 
                               int work_num_item, 
                               int split_flag)
{
  int k = get_global_id(1)/5;
  int m = get_global_id(1)%5;
  int j = get_global_id(0)+1;
  int dummy = 0;
  ...
  __local double (* tmp2_l_lhs)[3][5][5] = (__local double(*) [3][5][5])tmp_l_lhs;
  __local double (* l_lhs)[5][5] = tmp2_l_lhs[l_j];
  __local double (* tmp2_l_r)[2][5] = (__local double(*)[2][5])tmp_l_r;
  __local double (* l_r)[5] = tmp2_l_r[l_j];  
...
__kernel void y_solve1_fullopt(__global double *m_lhsA, 
                               __global double *m_lhsB, 
                               __global double *m_lhsC,
                               int gp0, int gp1, int gp2,
                               int work_base, 
...
inline void compute_fjac_y(__private double fjac[5][5], 
                           __private double t_u[5], 
                           double rho_i, 
                           double square, 
                           double qs,
...
inline void compute_njac_y(__private double njac[5][5], 
                           __private double t_u[5], 
                           double rho_i,
                           double c3c4, 
                           double con43, 
...
void y_solve2_fullopt(__global double *m_qs, 
                      __global double *m_rho_i,
                      __global double *m_square, 
                      __global double *m_u, 
                      __global double *m_lhsA, 
...
__kernel void y_solve3_fullopt(__global double *m_rhs,
                               __global double *m_lhsA, 
                               __global double *m_lhsB, 
                               __global double *m_lhsC,
                               int gp0, int gp1, int gp2,
...
{ 
  ...
  __local double (* tmp2_l_lhs)[3][5][5] = (__local double(*) [3][5][5])tmp_l_lhs;
  __local double (* l_lhs)[5][5] = tmp2_l_lhs[l_i];
  __local double (* tmp2_l_r)[2][5] = (__local double(*)[2][5])tmp_l_r;
  __local double (* l_r)[5] = tmp2_l_r[l_i];  
...
//---------------------------------------------------------------------
__kernel void z_solve_datagen_fullopt(__global double *m_u,
                                      __global double *m_square, 
...
// This function computes the left hand side for the three z-factors   
//---------------------------------------------------------------------
__kernel void z_solve1_fullopt(__global double *m_lhsA, 
                               __global double *m_lhsB, 
                               __global double *m_lhsC,
                               int gp0, int gp1, int gp2,
                               int work_base, 
                               ...
                               int split_flag)
{
  ...
  __global double (* lhsA)[5][PROBLEM_SIZE+1][WORK_NUM_ITEM_DEFAULT_J][PROBLEM_SIZE-1]
    = (__global double (*) [5][PROBLEM_SIZE+1][WORK_NUM_ITEM_DEFAULT_J][PROBLEM_SIZE-1])m_lhsA;
  __global double (* lhsB)[5][PROBLEM_SIZE+1][WORK_NUM_ITEM_DEFAULT_J][PROBLEM_SIZE-1]
    = (__global double (*) [5][PROBLEM_SIZE+1][WORK_NUM_ITEM_DEFAULT_J][PROBLEM_SIZE-1])m_lhsB;
  __global double (* lhsC)[5][PROBLEM_SIZE+1][WORK_NUM_ITEM_DEFAULT_J][PROBLEM_SIZE-1]
    = (__global double (*) [5][PROBLEM_SIZE+1][WORK_NUM_ITEM_DEFAULT_J][PROBLEM_SIZE-1])m_lhsC;
...
// This function computes the left hand side for the three z-factors   
//---------------------------------------------------------------------
inline void compute_fjac_z(__private double l_fjac[5][5], 
                           __private double t_u[5], 
                           double square, 
                           double qs, 
                           double c1, 
...
inline void compute_njac_z(__private  double l_njac[5][5], 
                           __private double t_u[5], 
                           double c3c4, 
                           double c1345, 
                           double con43, 
...
__kernel __attribute__((reqd_work_group_size(SOL2_D0_SIZE,1,1)))
void z_solve2_fullopt(__global double *m_qs, 
                      __global double *m_square, 
                      __global double *m_u,
                      __global double *m_lhsA, 
                      __global double *m_lhsB, 
...
// This function computes the left hand side for the three z-factors   
//---------------------------------------------------------------------
__kernel void z_solve3_fullopt(__global double *m_rhs,
                               __global double *m_lhsA, 
                               __global double *m_lhsB, 
                               __global double *m_lhsC,
                               int gp0, int gp1, int gp2,
