...
__kernel void rhs1_baseline(__global double * m_rsd, 
...
__kernel void rhs1_datagen_baseline(__global double *m_u, 
...
void rhsx_baseline(__global double *m_flux,
                            __global double *m_u,
                            __global double *m_rho_i,
                            __global double *m_qs,
                            ...
                            int split_flag)
{
  ...
  if (k+work_base < 1 || k+work_base >= nz-1 || j >= jend)
    return;

  if (split_flag) k += 2;
  else k += work_base;

  __global double (* flux)[5] = tmp_flux[k][j];
...
__kernel void rhsy_baseline(__global double *m_flux,
                            __global double *m_u,
                            __global double *m_rho_i,
                            __global double *m_qs,
                            __global double *m_rsd,
...
__kernel void rhsz_baseline(__global double *m_flux,
