...
__kernel void jacld_blts_datagen_gmem(__global double *m_u, 
...
__kernel void jacld_blts_datacopy_gmem(__global double *m_rsd, 
...
__kernel void jacld_blts_KL_gmem(__global double *m_rsd,
                                 __global double *m_u,
                                 __global double *m_qs,
                                 __global double *m_rho_i,
