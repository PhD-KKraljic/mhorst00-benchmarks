...
__kernel void rhs1_gmem(__global double * m_rsd, 
...
__kernel void rhs1_datagen_gmem(__global double *m_u, 
...
inline void compute_flux1_x(__private double * flux1, 
                            __private double * p_u, 
                            double q, 
                            double u21)
{
  flux1[0] = p_u[1];
...
inline void compute_flux2_x(__private double * flux2, 
                            __private double * p_um1, 
                            __private double * p_u, 
                            double tmpm1, 
                            double tmp, 
                            double tx3)
...
__kernel __attribute__((reqd_work_group_size(RHSX_WG_D0, RHSX_WG_D1, 1)))
void rhsx_gmem(__global double *m_u, 
               __global double *m_rho_i,
               __global double *m_qs, 
...
void rhsy_gmem(__global double *m_u, 
               __global double *m_rho_i,
               __global double *m_qs, 
               __global double *m_rsd,
               int ist, int iend, 
...
void rhsz_gmem(__global double *m_u, 
               __global double *m_rho_i,
               __global double *m_qs, 
               __global double * m_rsd,
               int jst, int jend, 
