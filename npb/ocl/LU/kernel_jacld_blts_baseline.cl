...
__kernel void jacld_blts_datagen_baseline(__global double *m_u, 
...
__kernel void jacld_blts_datacopy_baseline(__global double *m_rsd, 
...
__kernel void jacld_baseline(__global double *m_rsd,
                             __global double *m_u,
                             __global double *m_qs,
                             __global double *m_rho_i,
                             __global double *m_a,
...
__kernel void blts_KL_baseline(__global double *m_rsd,
                               __global double *m_u,
                               __global double *m_qs,
                               __global double *m_rho_i,
                               __global double *m_a,
