...
__kernel void jacu_buts_datagen_sync(__global double *m_u, 
...
void buts_BR_sync(__global double *m_v, 
                  __global double *m_rho_i,
                  __global double *m_u, 
                  __global double *m_qs,
...
__kernel void jacu_sync(__global double *m_rsd,
                        __global double *m_u,
                        __global double *m_qs,
                        __global double *m_rho_i,
                        __global double *m_au,
...
__kernel void buts_KL_sync(__global double *m_rsd,
                           __global double *m_u,
                           __global double *m_qs,
                           __global double *m_rho_i,
                           __global double *m_au,
