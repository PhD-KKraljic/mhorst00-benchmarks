...
inline void flux1_to_rsd(__private double rsd[5], 
                         __private double flux1m1[5], 
                         __private double flux1p1[5], double t2)
{
  int m;
  for(m = 0; m < 5; m++){
...
inline void flux2_to_rsd(__private double rsd[5], 
                         __private double p_um1[5], 
                         __private double p_u[5], 
                         __private double p_up1[5], 
                         __private double flux2[5], 
                         __private double flux2p1[5], 
                         __private double d[5], 
                         double t1,
                         double t3)
{
...
__kernel void rhs1_fullopt(__global double * m_rsd, 
...
__kernel void rhs1_datagen_fullopt(__global double *m_u, 
...
//---------------------------------------------------------------------
__kernel void rhsx1_fullopt(__local double *l_flux, 
                            __global double *m_u,
                            __global double *m_rho_i, 
                            __global double *m_qs,
                            ...
                            int split_flag)
{
  ...
  __local double (* flux)[5] = (__local double (*)[5])l_flux;
...
__kernel void rhsx2_fullopt(__local double *l_flux, 
                            __local double *m_l_u,
                            __global double *m_u, 
                            __global double *m_rsd,
                            __global double *m_rho_i,
                            int jst, int jend, 
                            ...
                            int split_flag)
{
  ...
  __local double (* flux)[5] = (__local double (*)[5])l_flux;
  __local double (* l_u)[5] = (__local double (*)[5])m_l_u;
...
//---------------------------------------------------------------------
__kernel void rhsx3_fullopt(__local double *m_l_u,
                            __global double *m_u,
                            __global double *m_rsd,
                            int jst, int jend,
...
inline void compute_flux1_y(__private double flux1[5], 
                            __private double p_u[5], 
                            double q, double u31)
{
  flux1[0] = p_u[2];
...
inline void compute_flux2_y(__private double flux2[5], 
                            __private double p_um1[5], 
                            __private double p_u[5], 
                            double tmpm1, 
                            double tmp, 
...
__kernel __attribute__((reqd_work_group_size(RHSY_WG_D0, RHSY_WG_D1, 1)))
void rhsy_fullopt(__global double *m_u, 
                  __global double *m_rho_i,
                  __global double *m_qs, 
                  __global double * m_rsd,
                  int ist, int iend, 
...
inline void compute_flux1_z(__private double * flux1, 
                            __private double * p_utmp, 
                            double q)
{
...
inline void compute_flux2_z(__private double * flux2, 
                            __private double * p_utmpm1, 
                            __private double * p_utmp, 
                            double tz3)
{
...
__kernel __attribute__((reqd_work_group_size(RHSZ_WG_D0, RHSZ_WG_D1, 1)))
void rhsz_fullopt(__global double *m_u, 
                  __global double *m_rho_i,
                  __global double *m_qs, 
                  __global double * m_rsd,
                  int jst, int jend, 
