...
#ifdef LIKWID_ROCMON
  printf("Initializing ROCMON marker\n");
  ROCMON_MARKER_INIT;
  ROCMON_MARKER_REGISTER("mg_marker");
  ROCMON_MARKER_START("mg_marker");
  printf("Set ROCMON marker 'mg_marker'\n");
#endif
  resid(n1, n2, n3, lt);
...
#ifdef LIKWID_ROCMON
  ROCMON_MARKER_STOP("mg_marker");
  ROCMON_MARKER_CLOSE;
  printf("Closed ROCMON markers\n");
#endif
