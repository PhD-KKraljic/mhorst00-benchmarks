...
__kernel void cffts1_base(__global dcomplex *xin,
                          ...
                          __global dcomplex *u,
                          __global dcomplex *tx,
                          __global dcomplex *ty,
                          int is,
                          int d1,
                          int d2,
                          int d3,
                          int logd1)
{
  ...
  __global dcomplex *tx_kj = &tx[k*d2*d1 + j*d1];
  __global dcomplex *ty_kj = &ty[k*d2*d1 + j*d1];
  ...
  cfftz_base(is, logd1, d1, u, tx_kj, ty_kj, lid, lws);
                          ...
                          int logd2)
{
  ...
  __global dcomplex *tx_ki = &tx[k*d1*d2 + i*d2];
  __global dcomplex *ty_ki = &ty[k*d1*d2 + i*d2];
  ...
  cfftz_base(is, logd2, d2, u, tx_ki, ty_ki, lid, lws);
                          ...
                          int logd3)
{
  ...
  __global dcomplex *tx_ji = &tx[j*d1*d3 + i*d3];
  __global dcomplex *ty_ji = &ty[j*d1*d3 + i*d3];
  ...
  cfftz_base(is, logd3, d3, u, tx_ji, ty_ji, lid, lws);
                ...
                int lid, int lws)
{
  ...
  for (int k = lid; k < n; k += lws) {
    ...
    y[i1] = dcmplx_add(x1, x2);
    dcomplex tmp = dcmplx_sub(x1, x2);
    y[i2] = dcmplx_mul(u1, tmp);
  }
}
                             ...
                             int logd1)
{
  ...
  cfftz_inplace(is, logd1, d1, u, tx_kj, lid, lws);
                             ...
                             int logd2)
{
  ...
  cfftz_inplace(is, logd2, d2, u, tx_ki, lid, lws);
                             ...
                             int logd3)
{
  ...
  cfftz_inplace(is, logd3, d3, u, tx_ji, lid, lws);
