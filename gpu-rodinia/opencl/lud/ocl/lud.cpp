...
#ifdef LIKWID_ROCMON
    printf("setting ROCm LIKWID marker\n");
    ROCMON_MARKER_INIT;
    ROCMON_MARKER_REGISTER("roc_lud");
    ROCMON_MARKER_START("roc_lud");
#endif
#ifdef LIKWID_NVMON
    LIKWID_NVMARKER_INIT;
    LIKWID_NVMARKER_REGISTER("nv_lud");
    LIKWID_NVMARKER_START("nv_lud");
#endif
...
#ifdef LIKWID_ROCMON
    ROCMON_MARKER_STOP("roc_lud");
    ROCMON_MARKER_CLOSE;
    printf("ROCm LIKWID marker closed\n");
#endif
#ifdef LIKWID_NVMON
    LIKWID_NVMARKER_STOP("nv_lud");
